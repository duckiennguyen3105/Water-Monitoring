...
public class Tremor_Activities extends Fragment implements SensorEventListener {
    ...
    public void onStart() {
        ...
        description.setText("Water flow");
    ...
    public Runnable runnable = new Runnable() {
        ...
        public void run() {
            ...
            if(sec == 20){
                ...
                Toast.makeText(getContext(),"Data has been stored to water flow history",Toast.LENGTH_LONG).show();
                int id = 1;

...
import com.Sislab.WaterMonitoring.model.TempViewer;
...
public class Temperator_Activity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_temperator_,container,false);
    }
    ...
    public void onStart() {
        ...
        databaseReference = firebaseDatabase.getReference("Quality-Timestamp/Temperature");
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if(dataSnapshot.hasChildren()){
                    for (DataSnapshot dataSnapshot1: dataSnapshot.getChildren()) {
                        TempViewer tempViewer = dataSnapshot1.getValue(TempViewer.class);
                        date = simpleDateFormat.format(new Date(tempViewer.getTimestamp()));
                        Xline.add(new Entry((tempViewer.getTimestamp())%86400000, tempViewer.getBasement()));
                        Yline.add(new Entry((tempViewer.getTimestamp())%86400000, tempViewer.getRoom1()));
                        Zline.add(new Entry((tempViewer.getTimestamp())%86400000, tempViewer.getRoom2()));
                    }
    ...
    private void showVabration(String date, ArrayList<Entry> lineX, ArrayList<Entry> lineY, ArrayList<Entry> lineZ) {
        ...
        lineFy.setLabel("Room 1");

        lineFz.setValues(lineZ);
        lineFz.setLabel("Room 2");

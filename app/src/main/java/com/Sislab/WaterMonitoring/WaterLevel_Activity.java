...
public class WaterLevel_Activity extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.activity_water_level_,container,false);
    }
    ...
    public void onStart() {
        ...
        databaseReference = firebaseDatabase.getReference("Quality-Timestamp/Water-Level");
